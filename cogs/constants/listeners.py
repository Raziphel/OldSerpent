...
class Listeners(Cog):
    ...
    async def on_messages(self, message):
        ...
        if message.channel.id in [1093622505236865045, 1056747785749278761, 1109756661331152996, 1159044488208056341, 1180049869549871197, 1180150920194043964]: #? Suggestions
            if message.author.bot:
                return
