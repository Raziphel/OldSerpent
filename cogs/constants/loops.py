...
class Loops(Cog):
    ...
    async def one_min_loop(self):
        ...
        playing = choice(["Trans-Rights are Human Rights!", "If you don't fites 4 trans rites you'll get bites.", "on the SCP Servers!", "Playing on the Lethal Company Modpack!", "Playing on the Minecraft Server!"])
