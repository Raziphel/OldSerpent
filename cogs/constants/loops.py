        ...
        for channel in channels:
            ...
            if last_message.id == sti.message_id:
                ...
                if channel in lounges:
                    ...
                    description=f"**Check out the new roles and channel tab at the top of the channels list!**", set_footer(text="Lounge stickys are updated occasionally to help with any changes."), color=randint(1, 0xffffff))
                try:
