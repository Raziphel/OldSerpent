...
class rules_handler(Cog):
    ...
    async def rules(self):
        ...
        embed1=Embed(title=f"**[- Staff Hierarchy -]**", 
        ...
        embed2=Embed(title=f"**[- Laws of Confuct -]**", 
        ...
        description=f"Please scroll up to read the server rules & staff hierarchy!", color=0x0000FF)
    ...
    async def no_channels_info(self):
        ...
        embed2=Embed(description=f"```fix\n█ Quick Fix! █\n```\nIf you are looking for a quick fix becuase you've just recently lost access to some channels, or some have just disapeared.\n**Consider clicking `Show All Channels` as seen below!", set_image="https://cdn.discordapp.com/attachments/550556052396179458/1133009744609673308/image.png", color=0xFFFFFF)
