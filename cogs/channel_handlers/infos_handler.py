...
class rules_handler(Cog):
    ...
    async def rules(self):
        ...
        embed8=Embed(description=f"```fix\n█ 8. Alt Accounts █\n```\nDue to potential user abuse, users are not allowed to have alts within the server. If a user is found with an alt, the alt(s) and main account will be removed. Please keep any and all alts out of the server.", color=0x0B1F00)
